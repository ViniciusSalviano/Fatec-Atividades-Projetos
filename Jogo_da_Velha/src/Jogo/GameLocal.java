...
public class GameLocal {
    public void ContraJogador(Scanner sc, Random randi){
        System.out.println("");
        ...
        while (jogoAcabou == false) {
            ...
            while (escolhaValida == false) {
                ...
                System.out.println("\n========= VEZ DO "+Maquina+" ==========");
                System.out.println("Digite a |linha| e |coluna| em que vc quer colocar o "+Maquina+"?");
                System.out.print("Linha: ");
                n1M = sc.nextInt()-1;
                System.out.print("Coluna: ");
                n2M = sc.nextInt()-1;
                ...
                //VERIFICA SE O JOGADOR ESCOLHEU UMA POSIÇÃO JÁ PREENCHIDA
                if (n1M < 0 || n1M > 2 || n2M < 0 || n2M > 2) {
                    System.out.println("Posição inexistente! Digite de 1 a 3.");
                } else if (!jogoatual[n1M][n2M].equals("-")) {
                    System.out.println("Essa posição já está ocupada!");
                } else {
